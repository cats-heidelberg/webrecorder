...
class Collection(PagesMixin, RedisUniqueComponent):
    ...
    def init_new(self, slug, title, url='', creatorList='', noteToDachs='', subjectHeaderList='', personHeaderList='', publisher='', collTitle='', publisherOriginal='', pubTitleOriginal='', personHeadingText='', collYear='', copTitle='', subjectHeadingText='', surName='', persName='', usermail='', emailOfRightsholder='', selectedGroupName='', projektcode='', publishYear='', listID='', desc='', public=False, public_index=False, ticketState='open', isCollLoaded=True, recordingUrl='', recordingTimestamp='2016010203000000', doi=''):
        ...
        self.data = {'title': title,
                     ...
                     'persName':persName,
                     'usermail':usermail,
                     'emailOfRightsholder':emailOfRightsholder,
